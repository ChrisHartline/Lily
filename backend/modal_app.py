...
import modal
from modal import Image, App, Secret, asgi_app, gpu, Volume
import os
...
@app.cls(
    image=image,
    gpu=gpu.T4(),  # Start with T4, upgrade to A10G if needed
    timeout=600,
    container_idle_timeout=300,
    volumes={MODEL_CACHE_DIR: model_volume},
    secrets=[Secret.from_name("huggingface-token", required=False)],
)
class ClaraModel:
    ...
    def __init__(self):
        ...
        self.knowledge_tokenizer = None
        self.personality_adapters = {}
        self.router_model = None
        self.current_adapter = "warmth"
